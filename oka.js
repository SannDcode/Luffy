...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `YassxOFC🍁`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;TaaOfc,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/c31ea54c441377970d979.jpg' }}}}
...
"inviteExpiration": `MY NAME YassXOFC${buttonkal}`,
"groupName": `MY NAME YassXOFC${buttonkal}`,
"caption": `${buttonkal}`,
...
await loading()
m.reply(`¥ *Price Sewa Bot YassxOFC* €
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY YASSxOFC`);
});
}
...
okta.sendMessage(from, {image: { url: result }, caption: 'YassxOFC SUKSES'},{quoted:m})
}
break
//=================================================
case 'cecanindo': {
...
//=================================================
case "listpanel": {
const text12 = `SEWA PANEL YASSXOFC ⚡
...
fs.unlinkSync(delb)
reply(`YASSxOFC Sukses Menambahkan Pdf\nCek dengan cara ${prefix}listpdf`)
}
}
break
//=================================================//
...
reply(`YASSxOFC Sukses delete pdf ${teks}`)
}
}
break
//=================================================//
...
m.reply(`YASSxOFC Sukses Mengirim Pesan Pdf Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`YassxOFC Sukses Menambahkan zip\nCek dengan cara ${prefix}listzip`)
}
}
break
//=================================================//
...
reply(`YassXOFC Sukses delete zip ${teks}`)
}
}
break
//=================================================//
...
m.reply(`YassxOFC Sukses Mengirim Pesan Zip Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`YassxOFC Sukses Menambahkan apk\nCek dengan cara ${prefix}listapk`)
}
}
break
//=================================================//
...
reply(`YassxOFC Sukses delete Apk ${teks}`)
}
}
break
//=================================================//
...
m.reply(`YassxOFC Sukses Mengirim Pesan Apk Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`YassxOFC Sukses Menambahkan Audio\nCek dengan cara ${prefix}listvn`)
}
break
//=================================================//
case 'delvn':{
...
reply(`YassxOFC Sukses delete vn ${text}`)
}
break
//=================================================//
case 'listvn':{
...
await loading()
 ...
 m.reply(`YassxOFC Sukses Mengirim Pesan Ke ${m.quoted.sender}`)
}
break
//=================================================//
case 'listmsg': {
...
m.reply(`*YassxOFC Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case "buatswimage":{
if (!isCreator) return m.reply('*Khusus Premium*')
