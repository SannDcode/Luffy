...
start(`1`,`Connecting...`)
  ...
  oka.sendMessage('6281535223390' + "@s.whatsapp.net", { text: `*halo yass*
  Telah Terhubung!!
  
  *_Jangan Lupa Untuk Subscribe Channel YASSxOFC Untuk Mendapatkan Info Terbaru.*
  
  *www.youtube.com/@YassxOFC.*` });
  success(`1`,`[■■■■■■■■■■■■■■■] Connected`) 
}
